...
data class DebugHotkeyVoiceOverlayResponse(
    ...
    val lifecycle_phase_label: String? = null,
    ...
    val render_phase_label: String? = null,
    val message: String? = null,
    val mic_live: Boolean = false,
    ...
    val asr_commit_reason: String? = null,
    val asr_last_partial: String? = null,
    val asr_final_text: String? = null,
    val asr_selected_transcript: String? = null,
    val asr_post_voice_silence_ms: Long? = null,
    val asr_partial_stable_ms: Long? = null,
    val asr_required_stable_ms: Long? = null,
    val asr_endpoint_armed: Boolean? = null,
    val asr_final_flush_ms: Long? = null,
    val asr_sample_count: Long? = null,
    val asr_audio_read_count: Long? = null,
    val asr_audio_read_error_count: Long? = null,
    val asr_peak_amplitude: Float? = null,
    val asr_last_frame_amplitude: Float? = null,
